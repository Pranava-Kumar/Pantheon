...
- [ ] Task: Verify existing MMCI infrastructure and current indicator outputs
...
- [ ] Task: Implement robust RSI calculation
    - [ ] Write tests for RSI calculation with various market scenarios (overbought, oversold, flat)
    - [ ] Refine `pantheon/data/indicators.py` to ensure RSI calculation matches `pandas-ta-classic` standards
- [ ] Task: Implement MACD and Moving Average indicators
    - [ ] Write tests for MACD signal line and histogram accuracy
    - [ ] Implement MACD and SMA/EMA logic in `pantheon/data/indicators.py`
